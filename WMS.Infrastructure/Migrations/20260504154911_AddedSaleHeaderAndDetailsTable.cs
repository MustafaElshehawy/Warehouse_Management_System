...
{
    /// <inheritdoc />
    public partial class AddedSaleHeaderAndDetailsTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleHeaders_Branches_BrancheId",
                        column: x => x.BrancheId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleHeaders_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostAtTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleHeaders_BrancheId",
                table: "SaleHeaders",
                column: "BrancheId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleHeaders_WarehouseId",
                table: "SaleHeaders",
                column: "WarehouseId");
        }
